...
##################################################################################################################
rm -rf ~/.config/btop ~/.config/ranger ~/.moc ~/.config/dunst/ ~/.zprofile ~/.xinitrc ~/.config/alacritty ~/.config/bspwm ~/.config/nvim ~/.config/bspwm/polybar ~/.config/zathura ~/.gitconfig ~/.config/gtk-3.0 ~/.gtkrc-2.0 ~/.tmux.conf ~/.zshrc ~/.zshrc-personal
